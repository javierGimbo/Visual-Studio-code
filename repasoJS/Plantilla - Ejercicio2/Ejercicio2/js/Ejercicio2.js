const url = "https://examen1-41fef-default-rtdb.europe-west1.firebasedatabase.app/"; const ext = ".json";
const comboCat = frmControles[0];
const comboProd = frmControles[1];
const divMostrarDatos = document.getElementById('datosProducto');
