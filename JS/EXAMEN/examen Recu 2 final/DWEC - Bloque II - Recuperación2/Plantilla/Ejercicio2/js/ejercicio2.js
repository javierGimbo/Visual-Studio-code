...
function ejecutar() {
  ...
  const radioSeleccionado = document.querySelector('input[name="operacionDOM"]:checked');
  const radioClonarSeleccionado = document.querySelector('input[name="clonado"]:checked');
  ...
  const valorClonar = radioClonarSeleccionado.value === "yes"; 
